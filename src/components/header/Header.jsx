                ...
                {type !== "list" &&
                    <>
                        ...
                        <p className="headerDesc">
                            Unlock 10% or more in instant savings with a free SoulSafari account. Join today and explore more!
                        </p>
                        ...
                        <div className="headerSearch">
                            ...
                            <div className="headerSearchItem">
                                ...
                                <span className="headerSearchText" onClick={() => setOpenOption(!openOptions)}>
