        ...
        <div className="footer">
            <div className="fLists">
                ...
                <ul className="fList">
                    ...
                    <li className="fListItem">soulSafari.com for Travel Agents</li>
                </ul>
                <ul className="fList">
                    <li className="fListItem">Coronavirus (COVID-19) FAQs</li>
                    <li className="fListItem">About soulSafari.com</li>
            ...
            <div className="fText">copyright &copy; 2024 soulSafari. All rights reserved.</div>
        </div>
    )
};
